  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-b from-secondary to-black">
      ...
      >
        ...
        >
          <a href="https://docs.google.com/document/d/1JwC1GO8PbEtL_U2pC9fkMxxVNfoj-u1s/edit?usp=sharing&ouid=105167766408245062414&rtpof=true&sd=true" className="bg-primary hover:bg-primary-dark text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-colors">
            <FileText size={20} />
            Download Resume
          </a>
